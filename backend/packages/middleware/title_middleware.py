...
from packages.config.title_config import get_title_config
from packages.models import create_chat_model
...
class TitleMiddleware(AgentMiddleware[TitleMiddlewareState]):
    ...
    async def _agenerate_title_result(self, state: TitleMiddlewareState) -> dict | None:
        ...
        try:
            if config.model_id:
                model = create_chat_model(config.model_id)
            else:
